...
function addFeetback(container){
    var span = document.createElement('span');
        span.classList.add('feetback');
    span.id = this.children.length + 1;

    var cur_url = '/assets/frontend/icons/avatars_profiles/rishick.jpg';

    span.innerHTML = '<div class="card-feedback"> \
        <div class="card-feedback-left"> \
            <svg class="avatar" xmlns="http://www.w3.org/2000/svg" width="128" height="105" fill="none" viewBox="0 0 214 211"> \
                <defs> \
                    <pattern id="fb-4" width="1" height="1" patternContentUnits="objectBoundingBox"> \
                        <use href="#img-fb-4" transform="translate(0 -.6) scale(.00174)"></use> \
                    </pattern> \
                    <image class="avatar" id="img-fb-4" width="576" height="1280" data-name="image.png" href="' + cur_url + '"></image> \
                </defs> \
                <rect width="197.234" height="197.234" x="8.067" y="10.59" fill="url(#fb-4)" stroke="#EA5657" stroke-width="3" rx="98.617"></rect> \
        ...
        <div class="card-feedback-right"> \
            <input class="projectTitle name" value="Даша Рыжик" readonly=""> \
            <string class="stars"> \
                <fieldset class="rating starts"> \
                    <input type="radio" id="star-fb-4-5" name="rating_fb-4" value="5">  \
                    <label class="full" for="star-fb-4-5" title="Awesome - 5 stars"></label>  \
                    <input type="radio" id="star-fb-4-4" name="rating_fb-4" value="4">  \
                    <label class="full" for="star-fb-4-4" title="Awesome - 4 stars"></label>  \
                    <input type="radio" id="star-fb-4-3" name="rating_fb-4" value="3">  \
                    <label class="full" for="star-fb-4-3" title="Awesome - 3 stars"></label>  \
                    <input type="radio" id="star-fb-4-2" name="rating_fb-4" value="2">  \
                    <label class="full" for="star-fb-4-2" title="Awesome - 2 stars"></label>  \
                    <input type="radio" id="star-fb-4-1" name="rating_fb-4" value="1" checked="">  \
                    <label class="full" for="star-fb-4-1" title="Awesome - 1 stars" hover=""></label>  \
                </fieldset>  \
            </string>  \
            <textarea class="text_area_feedback" style="height: 38px;">Прикольно, мне всё очень понравилось! Удобно, практично и красиво!</textarea>  \
        </div>  \
    </div>';  
