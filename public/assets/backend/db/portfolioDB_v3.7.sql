...
-- Started on 2025-05-17 15:18:01
...
--
-- TOC entry 217 (class 1259 OID 50010)
...
--
-- TOC entry 218 (class 1259 OID 50015)
...
--
-- TOC entry 219 (class 1259 OID 50016)
...
--
-- TOC entry 220 (class 1259 OID 50021)
...
--
-- TOC entry 221 (class 1259 OID 50022)
...
--
-- TOC entry 222 (class 1259 OID 50027)
...
--
-- TOC entry 223 (class 1259 OID 50032)
...
--
-- TOC entry 224 (class 1259 OID 50037)
...
--
-- TOC entry 225 (class 1259 OID 50038)
...
--
-- TOC entry 226 (class 1259 OID 50044)
...
--
-- TOC entry 227 (class 1259 OID 50049)
...
--
-- TOC entry 228 (class 1259 OID 50054)
...
--
-- TOC entry 230 (class 1259 OID 50068)
...
--
-- TOC entry 231 (class 1259 OID 50073)
...
--
-- TOC entry 232 (class 1259 OID 50074)
...
--
-- TOC entry 233 (class 1259 OID 50079)
...
--
-- TOC entry 234 (class 1259 OID 50084)
...
--
-- TOC entry 237 (class 1259 OID 50165)
...
--
-- TOC entry 238 (class 1259 OID 50166)
...
--
-- TOC entry 240 (class 1259 OID 50199)
-- Name: refs_id_project_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.refs_id_project_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.refs_id_project_seq OWNER TO postgres;

--
-- TOC entry 239 (class 1259 OID 50198)
...
ALTER SEQUENCE public.refs_id_seq OWNER TO postgres;

--
-- TOC entry 241 (class 1259 OID 50200)
-- Name: refs; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.refs (
    "Id" bigint DEFAULT nextval('public.refs_id_seq'::regclass) NOT NULL,
    id_project bigint DEFAULT nextval('public.refs_id_project_seq'::regclass) NOT NULL,
    url text NOT NULL
);
...
--
-- TOC entry 235 (class 1259 OID 50091)
...
--
-- TOC entry 236 (class 1259 OID 50096)
...
--
-- TOC entry 242 (class 1259 OID 50221)
...
--
-- TOC entry 243 (class 1259 OID 50222)
-- Name: vacancies; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.vacancies (
    id bigint DEFAULT nextval('public.vacancies_id_seq'::regclass) NOT NULL,
    name text,
    description text,
    duties json,
    tags json,
...
--
-- TOC entry 4768 (class 2604 OID 50103)
...
--
-- TOC entry 4769 (class 2604 OID 50104)
...
--
-- TOC entry 4770 (class 2604 OID 50105)
...
--
-- TOC entry 4772 (class 2604 OID 50106)
...
--
-- TOC entry 4777 (class 2604 OID 50107)
...
--
-- TOC entry 4778 (class 2604 OID 50109)
...
--
-- TOC entry 4963 (class 0 OID 50010)
-- Dependencies: 217
...
--
-- TOC entry 4965 (class 0 OID 50016)
-- Dependencies: 219
...
--
-- TOC entry 4967 (class 0 OID 50022)
-- Dependencies: 221
...
--
-- TOC entry 4968 (class 0 OID 50027)
-- Dependencies: 222
...
--
-- TOC entry 4969 (class 0 OID 50032)
-- Dependencies: 223
...
--
-- TOC entry 4971 (class 0 OID 50038)
-- Dependencies: 225
...
--
-- TOC entry 4972 (class 0 OID 50044)
-- Dependencies: 226
...
--
-- TOC entry 4973 (class 0 OID 50049)
-- Dependencies: 227
...
--
-- TOC entry 4974 (class 0 OID 50054)
-- Dependencies: 228
...
--
-- TOC entry 4975 (class 0 OID 50059)
-- Dependencies: 229
-- Data for Name: info_user; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.info_user (id, firstname, lastname, patronymic, login, roles, icon, hash, telephone, email, status, skills, "group", course, cipher, institute, year, specialization, education, about, division, goals, contacts, refs, socials) FROM stdin;
2	Кружков	Олег	Игоревич	krushkov	["superuser"]	oleg.svg	$2y$10$bBSiZdIZnmjyzeMYYq5XpeUdoq4vaMu8lmSk1g8i7YB/oBXS1AIne	+7(495)-777-11-22	root@vega.su	unblock	\N	КММО-01-23	\N	\N	\N	\N	Прикладная математика и информатика	Магистратура	\N	БК 536 РТУ МИРЭА	\N	\N	\N	\N
3	Сергей	Минеев	Алексеевич	mineev	["superuser"]	default_avatar_profile.jpg	$2y$10$OLX/zu1L.n4gf/4nYiO7/.giQFJ0dE2z8F9n3AqXQK4D.pSrvEoBu	+7(495)-777-11-22	root@vega.su	unblock	\N	КММО-01-23	\N	\N	\N	\N	Прикладная математика и информатика	Магистратура	\N	БК 536 РТУ МИРЭА	\N	\N	\N	\N
4	Даша	Рыжик	Алексеевна	rizhick	["superuser"]	rishick.jpg	$2y$10$8GTX2fm/OZuQcc8R/m8Ss.zXY3FAw9XkzvL0uXelRdpIIAXVU9egq	+7(495)-777-11-22	ya.ru	unblock	\N	КММО-01-23	\N	\N	\N	\N	Прикладная математика и информатика	Магистратура	\N	БК 536 РТУ МИРЭА	\N	\N	\N	\N
5	Ангелина	Ахтямова	Максимовна	gealya	["superuser"]	gealya.svg	$2y$10$JcwoQ1t8Ae2xxEvc5u4k5.1MyqhZFkNWU43ANPuI82SOAU81exD/i	-	\N	unblock	\N	\N	\N	\N	\N	\N	Прикладная математика и информатика	\N	\N	БК 536 РТУ МИРЭА	\N	\N	\N	\N
6	Борисов	Николай	Константинович	boris	["student"]	borisov.png	$2y$10$JcwoQ1t8Ae2xxEvc5u4k5.1MyqhZFkNWU43ANPuI82SOAU81exD/i	-	\N	unblock	\N	\N	\N	\N	\N	\N	Прикладная математика и информатика	\N	\N	БК 536 РТУ МИРЭА	\N	\N	\N	\N
1	Программик	Айтишникович	-	root@vega.su	["superuser"]	someone.svg	$2y$10$JcwoQ1t8Ae2xxEvc5u4k5.1MyqhZFkNWU43ANPuI82SOAU81exD/i	-	root@vega.su	unblock	["C","JS","SQL","C++","CSS","PHP","JWT","UML","HTML","Spark","Python","Docker","MS Office","PostgreSQL","Telegram Bot"]	КММО-01-23	3	25K0012	ИИ - Искусственного интеллекта	2025	Прикладная математика и информатика	Бакалавриат	Я люблю работать над проектами, которые позволяют мне применять теорию на практике. В своей учебе я сосредоточен на разработке веб-приложений и изучении алгоритмов. Участвовал в нескольких хакатонах, где смог не только улучшить свои технические навыки, но и научиться работать в команде.\r\n\r\nКроме программирования, меня интересуют новые технологии, такие как искусственный интеллект и машинное обучение. Я всегда открыт для новых идей и возможностей сотрудничества, поэтому не стесняйтесь обращаться ко мне!\r\n\r\nВ свободное время я люблю читать книги по саморазвитию и смотреть научно-популярные фильмы. Я верю, что постоянное обучение и обмен опытом — ключ к успеху в этой быстро меняющейся области.	БК 536 РТУ МИРЭА	["Выучить Python","Закрыть долг по физ-ре","Получить красный диплом"]	{"emails":["google@gmail.ru","tokenmsa89@gmail.com"],"phones":["+7(495)392-45-45","+7(777)777-71-72"],"sites":["http://ya.ru","http://vega.su","http://vega24.su"]}	["https://gitlab.com/MineevS/admlinux.git"]	["https://vk.com/msa_7","https://t.me/token0609","https://vk.com/msa_8"]
\.


--
-- TOC entry 4976 (class 0 OID 50068)
-- Dependencies: 230
...
--
-- TOC entry 4978 (class 0 OID 50074)
-- Dependencies: 232
...
--
-- TOC entry 4979 (class 0 OID 50079)
-- Dependencies: 233
...
33	2	2ftmrio9h60aaspfng7b47oqm4
\.


--
-- TOC entry 4984 (class 0 OID 50166)
-- Dependencies: 238
-- Data for Name: projects; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.projects (id, name, premier, status, stack, communities, experts, tags, icon, duration, goal, appointment, refs, artefacts, achievements, participants, author, description, team, screenshots, feedback) FROM stdin;
1	Сайт кафедры	2024-05-01	В архиве	\N	\N	\N	["Web-дизайн", "Backend", "Frontend", "Telegram_Bot", "Базы данных", "Тестирование_ПО", "Анализ_ПО"]	image-8.png	\N	\N	\N	\N	\N	\N	\N	1	"Русская Рулетка: Судьба на Кончиках Пальцев" — это захватывающая онлайн-игра, которая переносит классическую игру в русскую рулетку в виртуальный мир. Игроки могут испытать адреналин и напряжение, не выходя из дома, в безопасной и контролируемой среде. Игра сочетает в себе элементы стратегии, удачи и взаимодействия с другими игроками, создавая уникальный опыт.	\N	\N	\N
2	Игра в русскую рулетку	2024-05-01	Отменён	\N	\N	\N	["Frontend", "Telegram Bot"]	image-6.png	\N	\N	\N	\N	\N	\N	\N	1	"Русская Рулетка: Судьба на Кончиках Пальцев" — это захватывающая онлайн-игра, которая переносит классическую игру в русскую рулетку в виртуальный мир. Игроки могут испытать адреналин и напряжение, не выходя из дома, в безопасной и контролируемой среде. Игра сочетает в себе элементы стратегии, удачи и взаимодействия с другими игроками, создавая уникальный опыт.	\N	\N	\N
5	MindMosaic for Vega MIREA Mobile App	2024-05-01	В разработке	\N	\N	\N	["AI технологии"]	image-3.png	\N	\N	\N	\N	\N	\N	\N	1	MindMosaic — это инновационная платформа на основе искусственного интеллекта, предназначенная для создания и управления персонализированными образовательными маршрутами. Проект ориентирован на студентов, профессионалов и всех желающих углубить свои знания в различных областях.	\N	\N	\N
3	Интеллектуальный поиск	2024-05-01	Завершен	["JS","SQL","CSS","PHP","Git","UML","HTML","MS Office","PostgreSQL"]	\N	\N	["Backend","Frontend","Базы данных"]	image-5.png	\N	\N	\N	["http://github.com/MineevS","https://gitlab.com/MineevS"]	\N	\N	\N	1	Интеллектуальный поиск — это инновационная система, позволяющая быстро и удобно находить документы из коллекции кафедры. С помощью продвинутых алгоритмов обработки естественного языка, система анализирует запросы пользователей и предоставляет наиболее релевантные результаты. Интуитивно понятный интерфейс и фильтры по категориям делают поиск простым и эффективным, а возможность сохранения и организации найденных материалов помогает в работе над проектами и исследованиями. Откройте для себя новые знания с "Интеллектуальным поиском"!	{ "1" : ["2020", "н/в", "Руководитель проекта"], "2" : ["2022", "2025", "Fullstack программист"],"3" : ["2023", "2024", "UI/UX designer"]\n}	["1.png", "2.png", "3.png", "4.png", "5.png", "6.png"]	{"1":["4","\\u042d\\u0442\\u043e \\u043b\\u0443\\u0447\\u0448\\u0430\\u044f \\u0441\\u0438\\u0441\\u0442\\u0435\\u043c\\u0430 \\u0434\\u043b\\u044f \\u0440\\u0430\\u0431\\u043e\\u0442\\u044b \\u0441 \\u0438\\u043d\\u0444\\u043e\\u0440\\u043c\\u0430\\u0446\\u0438\\u043e\\u043d\\u043d\\u044b\\u043c\\u0438 \\u0440\\u0435\\u0441\\u0443\\u0440\\u0441\\u0430\\u043c\\u0438 \\u043d\\u0430\\u0448\\u0435\\u0439 \\u043a\\u0430\\u0444\\u0435\\u0434\\u0440\\u044b! \\u041e\\u0447\\u0435\\u043d\\u044c \\u0443\\u0434\\u043e\\u0431\\u043d\\u044b\\u0439 \\u043f\\u043e\\u0438\\u0441\\u043a \\u0438 \\u0430\\u043d\\u0430\\u043b\\u0438\\u0437 \\u0434\\u043e\\u043a\\u0443\\u043c\\u0435\\u043d\\u0442\\u043e\\u0432. \\u0421\\u043a\\u043e\\u0440\\u043e\\u0441\\u0442\\u044c \\u043d\\u0430\\u043f\\u0438\\u0441\\u0430\\u043d\\u0438\\u044f \\u043a\\u0443\\u0440\\u0441\\u043e\\u0432\\u044b\\u0445 \\u0443\\u0432\\u0435\\u043b\\u0438\\u0447\\u0438\\u043b\\u0430\\u0441\\u044c \\u0432\\u0434\\u0432\\u043e\\u0435!"],"2":[0,"123"]}
4	Дата-Шар	2024-05-01	Идёт набор	\N	\N	\N	["Data science", "Базы данных"]	image-7.png	\N	\N	\N	\N	\N	\N	\N	3	Мощная и интуитивно понятная платформа для управления и анализа данных, предназначенная для бизнеса, исследователей и разработчиков. Проект предоставляет инструменты для эффективной работы с большими объемами информации, обеспечивая легкий доступ к данным и их анализ.	\N	\N	\N
\.


--
-- TOC entry 4987 (class 0 OID 50200)
-- Dependencies: 241
-- Data for Name: refs; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.refs ("Id", id_project, url) FROM stdin;
0	1	http://github.com/MineevS
1	1	https://gitlab.com/MineevS
\.


--
-- TOC entry 4981 (class 0 OID 50091)
-- Dependencies: 235
...
--
-- TOC entry 4989 (class 0 OID 50222)
-- Dependencies: 243
...
SELECT pg_catalog.setval('public.like_project_id_seq', 35, true);
...
-- Dependencies: 240
-- Name: refs_id_project_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.refs_id_project_seq', 1, false);
...
SELECT pg_catalog.setval('public.vacancies_id_seq', 17, true);


--
-- TOC entry 4784 (class 2606 OID 50112)
...
--
-- TOC entry 4786 (class 2606 OID 50114)
...
--
-- TOC entry 4788 (class 2606 OID 50116)
...
--
-- TOC entry 4790 (class 2606 OID 50118)
...
--
-- TOC entry 4792 (class 2606 OID 50120)
...
--
-- TOC entry 4794 (class 2606 OID 50122)
...
--
-- TOC entry 4796 (class 2606 OID 50124)
...
--
-- TOC entry 4798 (class 2606 OID 50126)
...
--
-- TOC entry 4800 (class 2606 OID 50128)
...
--
-- TOC entry 4804 (class 2606 OID 50130)
...
--
-- TOC entry 4802 (class 2606 OID 50132)
...
--
-- TOC entry 4806 (class 2606 OID 50134)
...
--
-- TOC entry 4808 (class 2606 OID 50136)
...
--
-- TOC entry 4812 (class 2606 OID 50173)
...
--
-- TOC entry 4814 (class 2606 OID 50208)
-- Name: refs references_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4810 (class 2606 OID 50140)
...
--
-- TOC entry 4816 (class 2606 OID 50229)
...
--
-- TOC entry 4962 (class 0 OID 50074)
-- Dependencies: 232
...
-- Completed on 2025-05-17 15:18:02
