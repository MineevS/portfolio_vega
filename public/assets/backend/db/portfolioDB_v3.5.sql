...
-- Started on 2025-01-30 15:06:45
...
COPY public.info_user (id, firstname, lastname, patronymic, login, roles, icon, hash, telephone, email, status, skills, "group", course, cipher, institute, year_start, specialization, educational_program, about, division, goals, contacts) FROM stdin;
2	Кружков	Олег	Игоревич	krushkov	["superuser"]	oleg.svg	$2y$10$bBSiZdIZnmjyzeMYYq5XpeUdoq4vaMu8lmSk1g8i7YB/oBXS1AIne	+7(495)-777-11-22	root@vega.su	unblock	\N	КММО-01-23	\N	\N	\N	\N	Прикладная математика и информатика	Магистратура	\N	БК 536 РТУ МИРЭА	\N	\N
3	Сергей	Минеев	Алексеевич	mineev	["superuser"]	default_avatar_profile.jpg	$2y$10$OLX/zu1L.n4gf/4nYiO7/.giQFJ0dE2z8F9n3AqXQK4D.pSrvEoBu	+7(495)-777-11-22	root@vega.su	unblock	\N	КММО-01-23	\N	\N	\N	\N	Прикладная математика и информатика	Магистратура	\N	БК 536 РТУ МИРЭА	\N	\N
4	Даша	Рыжик	Алексеевна	rizhick	["superuser"]	rishick.jpg	$2y$10$8GTX2fm/OZuQcc8R/m8Ss.zXY3FAw9XkzvL0uXelRdpIIAXVU9egq	+7(495)-777-11-22	ya.ru	unblock	\N	КММО-01-23	\N	\N	\N	\N	Прикладная математика и информатика	Магистратура	\N	БК 536 РТУ МИРЭА	\N	\N
5	Ангелина	Ахтямова	Максимовна	gealya	["superuser"]	gealya.svg	$2y$10$JcwoQ1t8Ae2xxEvc5u4k5.1MyqhZFkNWU43ANPuI82SOAU81exD/i	-	\N	unblock	\N	\N	\N	\N	\N	\N	Прикладная математика и информатика	\N	\N	БК 536 РТУ МИРЭА	\N	\N
6	Борисов	Николай	Константинович	boris	["student"]	borisov.png	$2y$10$JcwoQ1t8Ae2xxEvc5u4k5.1MyqhZFkNWU43ANPuI82SOAU81exD/i	-	\N	unblock	\N	\N	\N	\N	\N	\N	Прикладная математика и информатика	\N	\N	БК 536 РТУ МИРЭА	\N	\N
1	Программик	Айтишникович	-	root@vega.su	["superuser"]	someone.svg	$2y$10$JcwoQ1t8Ae2xxEvc5u4k5.1MyqhZFkNWU43ANPuI82SOAU81exD/i	-	root@vega.su	unblock	["SQL", "C++", "C", "HTML", "CSS", "JS", "PHP", "PostgreSQL", "Spark", "Python", "Docker", "JWT", "Telegram Bot", "UML", "MS Office"]	КММО-01-23	3	25K0012	искусственного интеллекта	2026	Прикладная математика и информатика	Магистратура	Я люблю работать над проектами, которые позволяют мне применять теорию на практике. В своей учебе я сосредоточен на разработке веб-приложений и изучении алгоритмов. Участвовал в нескольких хакатонах, где смог не только улучшить свои технические навыки, но и научиться работать в команде.\n\nКроме программирования, меня интересуют новые технологии, такие как искусственный интеллект и машинное обучение. Я всегда открыт для новых идей и возможностей сотрудничества, поэтому не стесняйтесь обращаться ко мне!\n\nВ свободное время я люблю читать книги по саморазвитию и смотреть научно-популярные фильмы. Я верю, что постоянное обучение и обмен опытом — ключ к успеху в этой быстро меняющейся области.	БК 536 РТУ МИРЭА	["Выучить Python", "Закрыть долг по физ-ре", "Получить красный диплом"]	{"emails":["google@gmail.ru","tokenmsa89@gmail.com"],"phones":["+7(495)392-45-45","+7(777)777-71-72"],"sites":["http://ya.ru","http://vega.su"]}
\.
...
3	Игра в русскую рулетку	\N	Отменён	\N	\N	\N	["Frontend", "Telegram Bot"]	image-6.png	\N	\N	\N	\N	\N	\N	\N	1	"Русская Рулетка: Судьба на Кончиках Пальцев" — это захватывающая онлайн-игра, которая переносит классическую игру в русскую рулетку в виртуальный мир. Игроки могут испытать адреналин и напряжение, не выходя из дома, в безопасной и контролируемой среде. Игра сочетает в себе элементы стратегии, удачи и взаимодействия с другими игроками, создавая уникальный опыт.	\N	\N	\N
...
4	MindMosaic for Vega MIREA Mobile App	\N	В разработке	\N	\N	\N	["AI технологии"]	image-3.png	\N	\N	\N	\N	\N	\N	\N	1	MindMosaic — это инновационная платформа на основе искусственного интеллекта, предназначенная для создания и управления персонализированными образовательными маршрутами. Проект ориентирован на студентов, профессионалов и всех желающих углубить свои знания в различных областях.	\N	\N	\N
...
-- Completed on 2025-01-30 15:06:46
